    ...
    <div class="ops-body">
      <aside class="side" :class="sidebarCollapsed ? 'collapsed' : ''">
        ...
        <div class="side-scroll">
          ...
          <div :class="navCls('operationManage')" @click="onSubnav('operationManage', 'operationManage')">
            <span class="nav-ico">◫</span>
          ...
          <div :class="navCls('shopGoods')" @click="onSubnav('shopGoods', 'shopGoods')">
            <span class="nav-ico">▥</span>
          ...
          <div :class="navCls('taskCenter')" @click="onSubnav('taskCenter', 'taskCenter')">
            <span class="nav-ico">▧</span>
          ...
          <div :class="navCls('aiAssistant')" @click="onSubnav('aiAssistant', 'aiAssistant')">
            <span class="nav-ico">✦</span>
