...
/** 应用意见反馈四分类（与系统反馈同构：提交时必选其一） */
export const APP_FB_TYPES = ['体验反馈', 'BUG反馈', '优化反馈', '新需求提交'];
...
export const seedAppFeedbacks: AppFeedback[] = [
  { id: 'af-1', appId: 'c-1', user: '黄亚芳', content: '希望巡店报告支持一键导出周报，周一汇报会方便很多。', date: '2026/08/21', version: '1.0.0', type: '新需求提交', read: false },
  { id: 'af-2', appId: 'c-2', user: '杨帆', content: '希望灵感库支持按行业筛选，比如优先看美妆类的脚本。', date: '2026/08/21', version: '1.0.0', type: '新需求提交', read: false },
  { id: 'af-3', appId: 'c-1', user: '吴孝朝', content: '问题指派时希望能一次选多个人，现在只能逐个指派。', date: '2026/08/20', version: '1.0.0', type: '优化反馈', reply: { text: '已收到，多人指派能力在排期中，预计下个版本上线。', date: '2026/08/21' } },
  { id: 'af-4', appId: 'c-2', user: '郑婷', content: '脚本预览时字号偏小，希望增加字号调节。', date: '2026/08/19', version: '1.0.0', type: '体验反馈', images: ['/products/serum.png'] },
  { id: 'af-5', appId: 'c-1', user: '陈晓', content: '现场记录拍照上传压缩有点重，希望提供原图上传开关。', date: '2026/08/18', version: '1.0.0', type: 'BUG反馈', reply: { text: '已确认，v1.1.0 会提供原图上传开关，敬请关注。', date: '2026/08/19' } },
];
